...
<body>
  ...
  <div class="dashboard" role="main" aria-label="Dashboard de productos">
      ...
      <?php else: ?>
        <ul class="listaBajoStock" id="bajoStockList">
          <?php foreach ($productosBajoStock as $producto): ?>
            <li class="stock-item <?php echo $producto['stock_actual'] == 0 ? 'stock-cero' : 'stock-bajo'; ?>">
              ...
              <a href="modules/productos/productos.php?editar=<?php echo $producto['id']; ?>" class="btn-small">Reabastecer</a>
            </li>
          <?php endforeach; ?>
        </ul>
      <?php endif; ?>
    ...
    <div class="dashboard-stats">
      ...
      <div class="stat-card">
        <h3>Proveedores</h3>
        <p class="stat-number" id="totalProveedores">Cargando...</p>
      </div>
      <div class="stat-card">
        <h3>Stock Bajo</h3>
        <p class="stat-number" id="totalBajoStock"><?php echo count($productosBajoStock); ?></p>
      </div>
    </div>
  </div>
